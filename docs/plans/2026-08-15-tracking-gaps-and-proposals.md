...
**SHIPPED 2026-08-22.** The "she was asked to count early" escape hatch is what made this hard, and the first cut got four things wrong that two reviewers reproduced in a browser. The override was stored per-uid with nothing naming the pregnancy, so a midwife's "count from 26 weeks" survived a loss and met her again at seven weeks in the next pregnancy: it is stamped with the pregnancy id now. It was also read BEFORE the stage, so a leftover flag beat the trying-stage guard and handed a kick counter to a woman who is not pregnant; the stage is read first, and the week rows are not listed at all when there is no gestation to measure. Tapping a gated row on and off again deleted the pick as well as the override, so 28 weeks arrived and nothing came back; off now undoes exactly what on did. And a week gate emptying her surfaces was reading as her emptying them: turning ONE row off at ten weeks took the round button off every screen and told her she had chosen nothing. Gate: `tools/quick_minweek_check.js`.
