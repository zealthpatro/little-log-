...
(function () {
  window.cubbyLanding = function (msg) {
    ...
    return '<div class="lp">'
      ...
      + '</ul></div>'
      + '</div>'
      + '<p class="lp-pro-note">Free shares carry a small "made with Cubby · little-cubby.com" mark; Pro shares are clean. Routines, push reminders &amp; insights are on the Pro roadmap for later. Sign in, then join the Pro waitlist from Settings, Cubby Pro.</p></section>'
