...
(function () {
  ...
  var NO_TEACH = {
    ...
    showCodeBox: 'Reveals the six-digit box and wires it. One control, one implementation, so the sign-in routes cannot drift apart. Plumbing inside a flow, and the panel that calls it does the explaining.',
    showEmailSent: 'The second panel of email sign-in: confirms the email went out and offers the six-digit box, drawn from what the sender said that email contains. A step inside one flow, and it explains itself on screen.',
